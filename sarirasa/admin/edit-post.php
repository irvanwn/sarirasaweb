...
if (strlen($_SESSION['login']) == 0) {
    ...
    <head>
        ...
        <!-- App title -->
        <title>Sari Rasa | Tambah Highlight</title>
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <?php
                    $postid = intval($_GET['pid']);
                    $query = mysqli_query($con, "select highlight.id as postid, highlight.highlightIMG, highlight.title as title, highlight.description from highlight where highlight.id='$postid' and highlight.Active=1 ");
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    ...
                                                    <img src="postimages/<?php echo htmlentities($row['highlightIMG']); ?>"
                                                        width="300" />
                                                    <br />
                                                    <a
